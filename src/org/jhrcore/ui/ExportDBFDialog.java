 ...
 * @author mxliteboss
 */
public class ExportDBFDialog extends javax.swing.JDialog {
    ...
    private Logger log = Logger.getLogger(ExportDBFDialog.class.getName());
    ...
    public ExportDBFDialog(Class entity_class, FTable fTable, String module_code, List<TempFieldInfo> fields) {
        super();
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(pnlRight, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 216, Short.MAX_VALUE))
                        .addContainerGap())
                    .addGroup(layout.createSequentialGroup()
                        .addComponent(jLabel4)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jtfTitle, javax.swing.GroupLayout.DEFAULT_SIZE, 370, Short.MAX_VALUE)
                        .addContainerGap())))
            .addComponent(jPanel2, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
            .addComponent(jSeparator1, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 454, Short.MAX_VALUE)
        );
    ...
    private void setupEvents() {
        ...
        btnOk.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                refreshScheme();
                File file = FileChooserUtil.getDBFExportFile(CommMsg.SELECTFILE_MESSAGE);
                if (file == null) {
                    return;
                }
                exportDBF(file);
    ...
    private void exportDBF(final File selectedFile) {
        ShowProcessDlg.startProcess(ExportDBFDialog.this);
        ExportDBFDialog.this.setEnabled(false);
...
//        rowData[0] = "钟钊";
//        rowData[1] = Calendar.getInstance().getTime();
//        rowData[2] = new Double(5000.200);
//
//        writer.addRecord(rowData);
//
...
//        rowData[0] = "1002";
//        rowData[1] = Calendar.getInstance().getTime();
//        rowData[2] = new Double(7350.0220);
//        
//        writer.addRecord(rowData);
//
//        FileOutputStream fos = new FileOutputStream("1.dbf");
//        writer.write(fos);
//        fos.close();
//    }
}
