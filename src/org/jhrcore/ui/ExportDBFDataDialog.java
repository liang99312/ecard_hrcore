 ...
 * @author mxliteboss
 */
public class ExportDBFDataDialog extends javax.swing.JDialog {
    ...
    private Logger log = Logger.getLogger(ExportDBFDataDialog.class.getName());

    /** Creates new form ExportDataDialog */
    public ExportDBFDataDialog(java.awt.Frame parent, FTable ftable) {
        super(parent);
        this.setTitle("选择输出列");
        this.fTable = ftable;
    ...
    private void initOthers() {
        ...
        if (field_keys == null) {
            for (String field : fields) {
                all_fields.add(createShowField("", field, i));
                i++;
            }
        } else {
            for (String group_key : fields) {
    ...
    private void exportDBF() {
        try {
            ...
            DBFField fields[] = new DBFField[right_list.size()];
            int j = 0;
            for (TempFieldInfo tfi : right_list) {
                String type = tfi.getField_type().toLowerCase();
                fields[j] = new DBFField();
                fields[j].setName(tfi.getCaption_name());
            ...
            for (Object obj : fTable.getObjects()) {
                ...
                Object rowData[] = new Object[right_list.size()];
                for (TempFieldInfo tfi : right_list) {
                    Object tmp_obj = objs[col];
                    String type = tfi.getField_type().toLowerCase();
